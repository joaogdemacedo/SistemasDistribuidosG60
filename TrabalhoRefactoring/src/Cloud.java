...
public class Cloud {
    ...
    public Cloud (int porto){
        ...
        this.noServers = lock.newCondition();
    }
    ...
    public synchronized void removerBid(int id){

        for(Bid b : this.bids){
            if(b.getId() == id){
                //System.out.println("1244532");
                this.bids.remove(b);
                return ;
            }
        }
    ...
    public synchronized void addBid(double bid, String nick, String tipo, int id){
    ...
    public Server haDisponivel (String tipo) throws InterruptedException {
        ...
        while(flag==0){
            System.out.print("A aguardar servidores...");
    ...
    public static void main(String []args){
        ...
        Server s2 = new Server(1,"id3","medium",999,"livre");
